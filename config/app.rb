Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-todo.com'
  config.app_name = 'Volt_todo'
  config.mailer.from = 'Volt_todo <no-reply@volt-todo.com>'
  ...
  #
  config.app_secret = '3OpkSoYE2QI0cdh_e9gtR74Cc99KThNseJBeQTq4-r8nZf9b4a6xhDY0M9rnGjehCYM'
